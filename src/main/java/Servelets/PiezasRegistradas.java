...
@WebServlet(name = "PiezasRegistradas", urlPatterns = {"/PiezasRegistradas"})
@MultipartConfig
public class PiezasRegistradas extends HttpServlet {
            ...
            try {
                ...
                while (rs.next()) {
                    out.print("<tr>"
                            ...
                            + "<td scope=\"row\" class=\"text-center\"> <span class=\"badge rounded-pill bg-dark\">" + rs.getBigDecimal("espesor_pieza") + "</span></td>"
