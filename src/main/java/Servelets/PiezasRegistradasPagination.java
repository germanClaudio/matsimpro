            ...
            try {
                ...
                while (rs.next()) {
                    ...
                    out.print("<tr>"
                            ...
                            + " <a href=\"editarPiezas.jsp?id_pieza=" + rs.getInt(1) + "&nombre_pieza=" + rs.getString("nombre_pieza") + "&material_pieza=" + rs.getString(3) + "&espesor_pieza=" + rs.getBigDecimal(4) + "&numero_pieza=" + rs.getString(5) + "&descripcion_pieza=" + rs.getNString(7) + "\" class=\"btn btn-primary btn-sm\" style=\"margin: 5px;\"> <i class=\"fa fa-pencil\" aria-hidden=\"true\" ></i> Editar</a>"
                            + " <a href=\"crearnuevoensayo.jsp?id_pieza=" + rs.getInt(1) + "&nombre_pieza=" + rs.getString("nombre_pieza") + "\" class=\"btn btn-success btn-sm\" style=\"margin: 5px;\"> <i class=\"bi bi-clipboard-plus\"></i> + Ensayo</a>"
                            + " <a href=\"borrarPiezas.jsp?id_pieza=" + rs.getInt(1) + "\" class=\"btn btn-danger btn-sm\" style=\"margin: 5px;\"> <i class=\"fa fa-trash\" aria-hidden=\"true\"></i> Eliminar</a>"
                            + " </div>"
                            + "</td>"
                            + "</tr>"
                    );
