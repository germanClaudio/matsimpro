    ...
    <%
        ...
        double a_80_minimo = 0;//Double.parseDouble(request.getParameter("a_80_minimo"));
            ...
            try {
                ...
                String sql = "SELECT * FROM alargamiento where id_ensayo='" + id_ensayo + "'";
        ...
        if (request.getParameter("enviar") != null ) { //Datos alargamiento----------------
                ...
                if(request.getParameter("ensayo_categoria").equalsIgnoreCase("Material Ensayado")){
                    ...
                    try {
                        ...
                        if(count > 0){
                            out.println(  "<div class=\"container mt-5\">"
                                        + "<div class=\"alert alert-success\" role=\"alert\"> Datos modificados con éxito a la BD! <br>"
                    ...
                    try {
                        ...
                        if(count > 0){
                            out.println(  "<div class=\"container mt-5\">"
                                        + "<div class=\"alert alert-success\" role=\"alert\"> Dato modificado con éxito a la BD! <br>"
                            ...
                            out.println("<div class=\"container mt-5\">"
                                        + "<div class=\"alert alert-danger\" role=\"alert\"> Upsssss... No se pudo modificar el dato en la BD. <br>"
                                        + " Puede que los datos del ensayo no se hayan cargado aún. Verifique la información ingresada e intentelo nuevamente por favor.</div>"
                                        + "<a href=\"ensayos.jsp\" class=\"btn btn-secondary\" id=\"form1\">Volver <i class=\"fa fa-arrow-circle-left\" aria-hidden=\"true\"></i></a>"
                                        + "</did>");
                            hidden="hidden";
                    ...
                    <div class="col-sm">
                        <form action="editarDatosAlar.jsp" method="post">
                            ...
                            <div class="form-group" id="alargamiento">
                                <b>Datos de Alargamiento - Id_alargamiento: <%=id_alargamiento%> - Id_ensayo: <%=id_ensayo%> </b>
                                    ...
                                    <div class="row gy-2 gx-3 align-items-center" id="form1">
                                        <div class="col-sm-2">
                                            <div class="input-group" id="a_porcentual">
                                                ...
                                                <input type="number" class="form-control" name="a_porcentual" placeholder="20%" min="0" max="99" step="1" value="<%=a_porcentual%>">
                                        ...
                                        <div class="col-sm-2">
                                            <div class="input-group" id="ag_porcentual">
                                                ...
                                                <input type="number" class="form-control" name="ag_porcentual" placeholder="20%" min="0" max="99" step="0.1" value="<%=ag_porcentual%>">
                                                <span class="input-group-text">%</span>
                                            </div>
                                        </div>
                                        <div class="col-sm-2">
                                            <div class="input-group" id="ag_90_porcentual">
                                                ...
                                                <input type="number" class="form-control" name="ag_90_porcentual" placeholder="20%" min="0" max="99" step="0.1" value="<%=ag_90_porcentual%>">
                                                <span class="input-group-text">%</span>
                                            </div>
                                        </div>
                                        <div class="col-sm-2">
                                            <div class="input-group" id="a_50">
                                                <span class="input-group-text">A-50</span>
                                                <input type="number" class="form-control" name="a_50" min="0" max="99" step="0.1" value="<%=a_50%>">
                                                <span class="input-group-text">%</span>
                                            </div>
                                        </div>
                                        <div class="col-sm-2">
                                            <div class="input-group" id="a_80">
                                                <span class="input-group-text">A-80</span>
                                                <input type="number" class="form-control" name="a_80" min="0" max="99" step="0.1" value="<%=a_80%>">
                                                <span class="input-group-text">%</span>
                                            </div>
                                        </div>
                                        <div class="col-sm-2">
                                            <div class="input-group" id="a_80_90">
                                                <span class="input-group-text">A-80(90°)</span>
                                                <input type="number" class="form-control" name="a_80_90" min="0" max="99" step="0.1" value="<%=a_80_90%>">
                                                <span class="input-group-text">%</span>
                                            </div>
                                        </div>
                                        <div class="col-sm-2">
                                            <div class="input-group" id="a_80_minimo">
                                                <span class="input-group-text">A-80(mín.)</span>
                                                <input type="number" class="form-control" name="a_80_minimo" min="0" max="99" step="0.1" value="<%=a_80_minimo%>">
                                                <span class="input-group-text">%</span>
                                            </div>
                                        </div>
                                    </div>
