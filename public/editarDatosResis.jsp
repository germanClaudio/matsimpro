            ...
            <div class="row">
                <div class="col-sm">
                    ...
                    <form action="editarDatosResis.jsp" method="post">
                        ...
                        <!-- Resistencia -->
                        <div class="form-group" id="form1">
                            <span class="input-group-text" style="background-color: #22a25d"><b>Datos Resistencia - Id_resistencia: <%=id_resistencia%> - Id_ensayo: <%=id_ensayo%></b></span>
                        </div>
                            ...
                            <div class="row gy-2 gx-3 align-items-center" id="form1">
                                ...
                                <div class="col-sm-2">
                                    <div class="input-group" id="rp_promedio">
                                        <div class="input-group-text">Rp promedio</div>
