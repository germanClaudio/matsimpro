            ...
            <div class="row">
                <div class="col-sm">
                    ...
                    <form  method="post" action="UploadNuevaPieza" enctype="multipart/form-data">
                        ...
                        <div class="form-group" id="form1">
                            <label for="formFile" class="form-label">Seleccionar Imagen de pieza</label>
                        ...
                        <div style="margin-bottom: 80px;">    
                            <button type="submit" id="form1" name="enviar" value="enviar" class="btn btn-primary">Registrar Pieza <i class="fa fa-floppy-o" aria-hidden="true"></i></button>
